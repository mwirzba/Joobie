       ...
       protected override void OnModelCreating(ModelBuilder modelBuilder)
       {
           ...
           modelBuilder.Entity<WorkingHours>().HasData(
            ...
            modelBuilder.Entity<Job>().HasData(
                ...
                new Job { Id=2, Name = "Junior .NET Developer", TypeOfContractId = 1, CompanyId = 2, WorkingHoursId = 2 , CategoryId =16},
                new Job { Id = 3, Name = "Senior .NET Developer", TypeOfContractId = 1, CompanyId = 2, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = "Starszy Inżynier Oprogramowania .NET", TypeOfContractId = 1, CompanyId = 3, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = "Programista .NET", TypeOfContractId = 1, CompanyId = 2, WorkingHoursId = 4, CategoryId = 16 },
                new Job { Id = 3, Name = "C# .Net developer", TypeOfContractId = 3, CompanyId = 5, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = ".NET Developer", TypeOfContractId = 5, CompanyId = 6, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = ".NET Developer", TypeOfContractId = 3, CompanyId = 7, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = "Software Engineer C#", TypeOfContractId = 3, CompanyId = 8, WorkingHoursId = 3, CategoryId = 16 },
                new Job { Id = 3, Name = "Quality Assurance", TypeOfContractId = 1, CompanyId = 7, WorkingHoursId = 3, CategoryId = 16 },
                new Job { Id = 3, Name = "Programista .NET", TypeOfContractId = 5, CompanyId = 9, WorkingHoursId = 1, CategoryId = 16 },
                new Job { Id = 3, Name = "Junior .NET Developer", TypeOfContractId = 5, CompanyId = 10, WorkingHoursId = 2, CategoryId = 16 },
                new Job { Id = 3, Name = "Azure DevOps", TypeOfContractId = 1, CompanyId = 11, WorkingHoursId = 3, CategoryId = 16 }
           );
       }
    }
}
